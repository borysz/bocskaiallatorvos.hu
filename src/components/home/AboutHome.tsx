import { Award, Clock, Users, Heart, PhoneForwarded } from 'lucide-react';
...
export default function AboutHome() {
    ...
    /*useEffect(() => {
        fetch(`${apiUrl}/pages?parent=18&_fields=menu_order,slug,title,content&slug=rolunk,kepzett-orvosok&orderby=menu_order&order=asc`)
            .then((res) => res.json())
            .then((data: WPPost[]) => setPages(data))
